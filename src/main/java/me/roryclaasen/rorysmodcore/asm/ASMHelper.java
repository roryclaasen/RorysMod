...
public final class ASMHelper {
	 ...
	 *
	 * @param cnode
	 *            the ClassNode to be converted into a byte array
	 * @param cwFlags
	 *            the flags to be supplied to the ClassWriter. You almost always want both COMPUTE_FRAMES and COMPUTE_MAXS
	...
	public static byte[] createBytes(ClassNode cnode, int cwFlags) {
		...
		RMLog.info(String.format("Class %s successfully transformed!", cnode.name), true);
		return bArr;
	}
	 ...
	 *
	 * @param bytes
	 *            A byte array representing the class to be modified by ASM
	 ...
	 * @param needle
	 *            The instruction set to search for
	 * @return The first instruction node from the haystack on the found position
	 * @throws me.roryclaasen.asm.rorysmodcore.transformer.ASMHelper.InvalidNeedleException
	 *             when the needle was not found or was found multiple times
	 */
	 ...
	 *
	 * @param cn
	 *            the ClassNode to be searched in
	 * @param method
	 ...
	 *            The method name to search for
	 * @param desc
	 *            The method descriptor to search for
	 * @return true, if the name was found, or else false
	 * @throws me.roryclaasen.asm.rorysmodcore.transformer.ASMHelper.MethodNotFoundException
	 *             when the method name and descriptor couldn't be found
	 */
	 ...
	 *
	 * @param mcp
	 *            The name to be used in a development environment
	 * @param srg
	 *            The name to be used in a productive environment
	 ...
	 *
	 * @param classBytes
	 *            The class bytes to be written as a class file
	 * @param file
	 *            The filename (inclusive path) the bytes will be saved in
	 */
